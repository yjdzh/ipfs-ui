 ...
 * components-toO, and can have many children themselves.
 *
...
vjs.Component = vjs.CoreObject.extend({
  ...
  init: function(player, options, ready){
    ...
    // Add any child components-toO in options
    this.initChildren();
...
/**
 * Dispose of the component and all child components-toO
 */
 ...
 *
 * This is used for merging options for child components-toO. We
...
/**
 * Get an array of all child components-toO
 *
...
/**
 * Object of child components-toO by ID
 *
 * @type {Object}
 * @private
 */
...
/**
 * Object of child components-toO by name
 *
 * @type {Object}
 * @private
 */
...
/**
 * Add and initialize default child components-toO from options
 *
...
vjs.Component.prototype.initChildren = function(){
  ...
  if (options && options['children']) {
    ...
    // Loop through components-toO and add them to the player
    vjs.obj.each(options['children'], function(name, opts){
      // Allow for disabling default components-toO
      // e.g. vjs.options['children']['posterImage'] = false
      if (opts === false) return;

      // Allow waiting to add components-toO until a specific event is called
...
/**
 * Allows sub components-toO to stack CSS class names
 *
 ...
 * If you set this.isReadyOnInitFinish_ it will affect all components-toO.
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Inits and embeds any child components-toO in opts
...
// When the player is first initialized, trigger activity so components-toO
