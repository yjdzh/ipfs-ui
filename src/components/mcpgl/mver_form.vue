<template>
    <EVpageForm :pageTitle="pageTitle+title" :model="formValidate" :rules="ruleValidate" :labelWidth="120"
        ...
        <div slot="form">
            ...
            <Row>
                <EVitemContainer label="所属产品名称" prop="productId" :span="12">
                    <Select v-model="formValidate.productId" :disabled="this.openType == -1 ? false : true">
                        <Option :value="option.id" :label="option.name" v-text="option.name" v-for="option in options"
                ...
                <EVitemContainer label="显示版本" prop="showVer" :span="12">
                    <Input v-model.trim="formValidate.showVer" placeholder="请输入显示版本"></Input>
                </EVitemContainer>
            </Row>
            ...
            <Row>
                ...
                <EVitemContainer label="内控版本" prop="ver" :span="12">
                    <Input v-model.trim="formValidate.ver" placeholder="请输入内控版本"></Input>
                </EVitemContainer>
                <EVitemContainer label="版本描述信息" prop="info" :span="12">
                    <Input type="textarea" :autosize="{minRows: 4,maxRows: 10}" v-model="formValidate.info" placeholder="请输入版本描述信息"></Input>
                </EVitemContainer>
            </Row>
            ...
            return {
                ...
                ruleValidate: {
                    ...
                    showVer: [{
                        ...
                        {
                            pattern: this.Regex.regexlist.nums,
                            message: '只能输入数和"."',
                            trigger: 'blur'
                        }
                    ],
