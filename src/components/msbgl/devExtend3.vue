...
<template>
    <div>
        ...
        <Row>
            ...
            <Col span="16">
                <span class="expand-key">本地IP：</span>
            ...
            <Col span="6">
                ...
                <span class="expand-value" v-text="f2poolType"></span>
            </Col>
            ...
            <Col span="6">
                <span class="expand-key">类型：</span>
                <span class="expand-value" v-text="minergateType"></span>
            </Col>
            <Col span="6">
                <span class="expand-key">账号：</span>
            ...
            <Col span="6">
                <span class="expand-key">类型：</span>
                <span class="expand-value" v-text="ipfsType"></span>
            </Col>
        ...
        methods: {
            ...
            ypjs: function(my_time) {
                ...
                for (var i = 0; i < str.length; i++) {
                    ...
                    totalRL += parseInt(childStr[2]);
                    usedRL += parseInt(childStr[3]);
                }
                return (usedRL / 1048576).toFixed(2) + '/' + (totalRL / 1048576).toFixed(2) + 'GB（使用率：' + (usedRL / totalRL).toFixed(
                    2) * 100 + '%)';
            },
            creat() {
                this.Global.ajax(
                    ...
                    function(res, that) {
                        if (res.data.status == 1) {
                            ...
                            that.nc = (rt106 / 1048576).toFixed(2) + '/' + (rt107 / 1048576).toFixed(2) + 'GB（使用率：' + (rt106 / rt107).toFixed(
                                2) * 100 + '%)';
