<template>
    <div class="evaninline">
        <div class="ivu-input-group-prepend evan-prepend">
        ...
        <div class="ivu-input-group-append evan-append" ><slot name="append"></slot></div>
    </div>
</template>
